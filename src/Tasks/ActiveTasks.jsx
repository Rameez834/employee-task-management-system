const ActiveTask = () => {
  return (
    <div>
       <div className="bg-gradient-to-br from-amber-700 to-indigo-700 w-full sm:w-[26rem] min-h-[20rem] sm:h-80 rounded-3xl shadow-2xl text-white">
        ...
        <div className="flex justify-between p-4 sm:p-5 gap-3">
          <button className="bg-gray-500 hover:bg-green-600 px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base flex-1 sm:flex-none">
            Active Task
          </button>
          <button className="bg-yellow-500 hover:bg-red-600 px-3 sm:px-4 py-2 rounded-lg text-sm sm:text-base flex-1 sm:flex-none">
            View Details
          </button>
        </div>
      </div>
